...
const useAppstate = useContext(Appstate);
  return (
    <div className= 'sticky z-10 header top-0 text-3xl flex justify-between text-red-500 font-bold p-3 border-b-2 border-grey-500'>
    ...
    :
    <Link to='/login'><h1 className='text-lg  text-white bg-green-600 hover:bg-green-700 cursor-pointer flex items-center'>
